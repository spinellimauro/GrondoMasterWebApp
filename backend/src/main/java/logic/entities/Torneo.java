...
public class Torneo {
	...
	@ManyToMany(fetch = FetchType.EAGER, targetEntity = Equipo.class)
	@JoinTable(name = "torneo_equipo", joinColumns = { @JoinColumn(name = "torneo_id", referencedColumnName = "id") }, inverseJoinColumns = { @JoinColumn(name = "equipo_id", referencedColumnName = "id")})
...
//}
	...
	public void setName(String nombreTorneo) {
		this.name = nombreTorneo;
	}
	...
	public void setListaEquipos(List<Equipo> listaParticipantes) {
		this.listaEquipos = listaParticipantes;
	}
	...
	public int getLimiteAmarillas() {
		return limiteAmarillas;
	}

	public void setLimiteAmarillas(int limiteAmarillas) {
